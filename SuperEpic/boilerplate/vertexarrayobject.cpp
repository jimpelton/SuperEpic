...
namespace hci {
  ...
  VertexArrayObject::~VertexArrayObject() {
    ...
    // Delete each VBO, one at a time, assoc'd with this VAO
    const int num_buffers_to_delete = 1;
    for (unsigned int u : m_bufIds) {
      glDeleteBuffers(num_buffers_to_delete, &u);
    }
  ...
  ///////////////////////////////////////////////////////////////////////////////
  unsigned int VertexArrayObject::addVbo(const float *verts, size_t length,
  ...
  ///////////////////////////////////////////////////////////////////////////////
  unsigned int VertexArrayObject::setIndexBuffer(
  ...
  ///////////////////////////////////////////////////////////////////////////////
  unsigned int VertexArrayObject::setIndexBuffer(unsigned short *indices,
    size_t length) {
  ...
  ///////////////////////////////////////////////////////////////////////////////
  unsigned int VertexArrayObject::gen_ibo(const unsigned short *indices, 
    size_t length) {
